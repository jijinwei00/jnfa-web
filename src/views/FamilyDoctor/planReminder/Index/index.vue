      ...
      >
        ...
        >
          <template slot-scope="scope">
            <el-button
              @click.native.prevent="handlePerform(scope.$index, tableData)"
              type="text"
              size="small"
            >
              执行
            ...
            <el-button
              @click.native.prevent="handleRemind(scope.$index, tableData)"
              type="text"
              size="small"
            >
              提醒
...
export default {
  ...
  methods: {
    ...
    // 执行
    handlePerform(index, record) {
      console.log('执行---->>>>>', record);
      alert('执行')
    },
    // 提醒
    handleRemind(index, record) {
      console.log('提醒---->>>>>', record);
      alert('提醒')
    },
    // 失访
